...
DATA_PATH="/public/share/huchen1/yuguo/wudao_glm-ice_final-merged/wudao_glm-ice_content_document"
# MULTITASK_DATA_PATH=""
NAME="GLM-130B"

CHECKPOINT_PATH=/public/share/huchen1/yuguo/checkpoints/$NAME
...
DP_SIZE=4
MICRO_BATCH_SIZE=1
GLOBAL_BATCH_SIZE=1152 # 8*36 * 4 * 1 acc*dp*bs
...
EPOCHES=1
TRAIN_TOKENS=$((121102772224 * EPOCHES)) # tokens
...
export CMD=" \
    ...
    --rampup-batch-size 16 8 $BATCH_WARMUP_SAMPLES \
